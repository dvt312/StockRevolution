		...
		tooltip: function() {
			...
			if (!this.tiktok_bubble) {
				switch(obj.settings.type){
					...
					break;
					case 'poptext':
					    this.tiktok_bubble = $('<div id="tiktok-pop" class="tiktok"><div class="tt-bg"></div><div class="tt-box tt-text"><div class="tt-box-header"></div><p></p><div class="tt-button"><a href="javascript:void(0);" id="tt-btn-cancel" class="tt-status-' + obj.settings.status + ' tt-button-single">' + obj.settings.buttonConfirm + '</a></div></div></div>');
					break;
					case 'popload':
